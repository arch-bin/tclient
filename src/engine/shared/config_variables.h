...
MACRO_CONFIG_INT(SvGrenadeSingleShot, sv_grenade_single_shot, 1, 0, 1, CFGFLAG_SERVER | CFGFLAG_GAME, "Grenade fires once per click instead of full-auto while held (1 press = 1 explosion)")
