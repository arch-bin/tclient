...
MACRO_CONFIG_INT(TcAntiVoidRocketDistance, tc_anti_void_rocket_distance, 1, 1, 3200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Anti-void rocket: how close to the void before it fires (the firing 'timing'), stored in tenths of a pixel so 10 = 1px (320px = 1 tile is value 320); min 1 = 0.1px for very tight timing")
